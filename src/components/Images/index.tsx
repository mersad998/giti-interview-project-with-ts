    ...
    return (
      <TouchableOpacity
        ...
        <View style={styles.CardTitle}>
          <CoustomTextComponent style={styles.title}>
            {item.item.title ? item.item.title : 'بدون نام'}
          </CoustomTextComponent>
        </View>
        <Image
          resizeMode={'stretch'}
...
const mapDispatchToProps = (dispatch: Function) => ({
  loadAlbumsPhotos: (payload) => loadAlbumsPhotos({payload, dispatch}),
  clearPhotos: (payload) => clearPhotos({payload, dispatch}),
});
