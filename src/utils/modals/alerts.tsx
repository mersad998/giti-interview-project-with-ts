...
export const Error = ({text, visible, confirm}: MessagesInterface) => (
  <Modal
    ...
    <View style={styles.view}>
      ...
      <Button primary transparent style={styles.button} onPress={confirm}>
        <CoustomTextComponent style={styles.confirmText}>
          تایید
...
export const Success = ({text, visible, confirm}: MessagesInterface) => (
  <Modal
    animationOut="fadeOutDown"
    animationIn="pulse"
    ...
    <View style={styles.view}>
      ...
      <View style={styles.viewConfirm}>
        <Button danger transparent onPress={dismiss} style={styles.btnConfirm}>
          <CoustomTextComponent style={styles.cancellText}>
            {txtDismiss || 'انصراف'}
          </CoustomTextComponent>
        </Button>
